...
public class HaiTuActivity extends AppCompatActivity {

    private ImageView LaBai[] = new ImageView[6];
    private TextView tvKetQua[] = new TextView[2] ;
    ...
    private Button MoBai[] = new Button[2];
    private Random r = new Random();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hai_tu);

        LaBai[0] = (ImageView) findViewById(R.id.img_2Tu_la1Tu1);
        LaBai[1] = (ImageView) findViewById(R.id.img_2Tu_la2Tu1);
        LaBai[2] = (ImageView) findViewById(R.id.img_2Tu_la3Tu1);
        tvKetQua[0] = (TextView)  findViewById(R.id.tv_2Tu_soNutTu1);
        MoBai[0] = (Button) findViewById(R.id.btn_2Tu_moTu1);

        LaBai[3] = (ImageView) findViewById(R.id.img_2Tu_la1Tu2);
        LaBai[4] = (ImageView) findViewById(R.id.img_2Tu_la2Tu2);
        LaBai[5] = (ImageView) findViewById(R.id.img_2Tu_la3Tu2);
        tvKetQua[1] = (TextView)  findViewById(R.id.tv_2Tu_soNutTu2);
        MoBai[1] = (Button) findViewById(R.id.btn_2Tu_moTu2);
    ...
    private void chiabai(View view) {
        ...
        int vt, tong;
        String ketqua;
        for (int j = 0; j<2; j++){                             //Có 2 tụ
            tong = 0;
            CacLaDaRut.clear();
            for (int i=0; i<3; i++) {                          //3 lá bài
                vt = r.nextInt(CacLaBai.size() - 1);
                CacLaDaRut.add(new LaBai(CacLaBai.get(vt)));
