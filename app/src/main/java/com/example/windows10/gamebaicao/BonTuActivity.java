...
public class BonTuActivity extends AppCompatActivity {

    private ImageView LaBai[] = new ImageView[12];
    private TextView tvKetQua[] = new TextView[4] ;
    ...
    private Button MoBai[] = new Button[4];
    private Random r = new Random();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bon_tu);

        LaBai[0] = (ImageView) findViewById(R.id.img_4Tu_la1Tu1);
        LaBai[1] = (ImageView) findViewById(R.id.img_4Tu_la2Tu1);
        LaBai[2] = (ImageView) findViewById(R.id.img_4Tu_la3Tu1);
        tvKetQua[0] = (TextView)  findViewById(R.id.tv_4Tu_soNutTu1);
        MoBai[0] = (Button) findViewById(R.id.btn_4Tu_moTu1);

        LaBai[3] = (ImageView) findViewById(R.id.img_4Tu_la1Tu2);
        LaBai[4] = (ImageView) findViewById(R.id.img_4Tu_la2Tu2);
        LaBai[5] = (ImageView) findViewById(R.id.img_4Tu_la3Tu2);
        tvKetQua[1] = (TextView)  findViewById(R.id.tv_4Tu_soNutTu2);
        MoBai[1] = (Button) findViewById(R.id.btn_4Tu_moTu2);

        LaBai[6] = (ImageView) findViewById(R.id.img_4Tu_la1Tu3);
        LaBai[7] = (ImageView) findViewById(R.id.img_4Tu_la2Tu3);
        LaBai[8] = (ImageView) findViewById(R.id.img_4Tu_la3Tu3);
        tvKetQua[2] = (TextView)  findViewById(R.id.tv_4Tu_soNutTu3);
        MoBai[2] = (Button) findViewById(R.id.btn_4Tu_moTu3);

        LaBai[9] = (ImageView) findViewById(R.id.img_4Tu_la1Tu4);
        LaBai[10] = (ImageView) findViewById(R.id.img_4Tu_la2Tu4);
        LaBai[11] = (ImageView) findViewById(R.id.img_4Tu_la3Tu4);
        tvKetQua[3] = (TextView)  findViewById(R.id.tv_4Tu_soNutTu4);
        MoBai[3] = (Button) findViewById(R.id.btn_4Tu_moTu4);
    ...
    private void mobai(View view) {
        if (CacTu.isEmpty()){
            ...
            if (view == MoBai[3]){
                for (int i=0; i<3; i++){
                    LaBai[i+9].setImageResource((CacTu.get(3).getCacLaDaRut().get(i).getHinh()));
                }
                tvKetQua[3].setText(CacTu.get(3).getKetQua());
            }
        }
    }
}
